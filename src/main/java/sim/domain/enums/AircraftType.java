...
public enum AircraftType {
    ...
    T_51D("T-51D", true, false, UNARMED, CLASSIC_ERAS, null, Arrays.asList(FactionType.AUSTRALIA, FactionType.CANADA, FactionType.CHINA, FactionType.FRANCE, FactionType.GERMANY, FactionType.INDONESIA, FactionType.ISRAEL, FactionType.ITALY, FactionType.JAPAN, FactionType.NETHERLANDS, FactionType.PHILIPPINES, FactionType.POLAND, FactionType.SOUTH_KOREA, FactionType.SWEDEN, FactionType.USSR, FactionType.USA, FactionType.USAF_AGGRESSORS)),
    ...
    FA_18C_LOT20("F/A-18C Lot 20", true, false, STRIKE_FIGHTER, MODERN_ERAS, FA_18_MUNITIONS, Arrays.asList(FactionType.AUSTRALIA, FactionType.CANADA, FactionType.KUWAIT, FactionType.SPAIN, FactionType.SWITZERLAND, FactionType.USA, FactionType.USAF_AGGRESSORS)),
    ...
    FA_18C("F/A-18C", false, false, STRIKE_FIGHTER, MODERN_ERAS, null, Arrays.asList(FactionType.AUSTRALIA, FactionType.CANADA, FactionType.KUWAIT, FactionType.SPAIN, FactionType.SWITZERLAND, FactionType.USA, FactionType.USAF_AGGRESSORS)),
