...
public enum AircraftType {
    ...
    AircraftType(String aircraftName, boolean playerFlyable, boolean isHelicopter, List<ConflictEraType> aircraftEras, Map<Integer, List<MunitionType>> stationMunitions, List<FactionType> users) {
