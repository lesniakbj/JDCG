...
import static sim.domain.statics.util.StaticLists.AIR_FORCE_AIR_SUPERIORITY_AVAILABLE_AIRCRAFT;
import static sim.domain.statics.util.StaticLists.AIR_SUPERIORITY;
