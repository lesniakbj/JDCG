...
public enum MapConstants {
    ...
    MapConstants(String mapName, Rectangle mapBounds, Pair<Integer, Integer> tempBlockWinter, Pair<Integer, Integer> tempBlockSpring, Pair<Integer, Integer> tempBlockSummer, Pair<Integer, Integer> tempBlockFall) {
